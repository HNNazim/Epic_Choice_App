...
class EpicFoodTourAdapter: RecyclerView.Adapter<EpicFoodTourAdapter.EpicFoodTourViewHolder>() {

    inner class EpicFoodTourViewHolder(private val binding: EpicbaseRvItemBinding): RecyclerView.ViewHolder(binding.root){
            ...
            binding.apply {
                ...
                if (product.price != null) {
                    product.offerPercentage?.let { offerPercentage ->
                        ...
                        tvEpicPlacesDetail.text = "$ ${String.format("%.2f", priceAfterTheOffer)}"
                        tvOldPrice.paintFlags = android.graphics.Paint.STRIKE_THRU_TEXT_FLAG
                        tvEpicPlacesDetail.visibility = View.VISIBLE
                    ...
                    tvEpicPlacesDetail.visibility = View.GONE
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): EpicFoodTourViewHolder {
        return EpicFoodTourViewHolder(
    ...
    override fun onBindViewHolder(holder: EpicFoodTourViewHolder, position: Int) {
