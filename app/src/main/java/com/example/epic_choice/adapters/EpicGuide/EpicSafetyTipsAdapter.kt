...
class EpicSafetyTipsAdapter: RecyclerView.Adapter<EpicSafetyTipsAdapter.EpicSafetyTipsViewHolder>() {

    inner class EpicSafetyTipsViewHolder(private val binding: EpicbaseRvItemBinding): RecyclerView.ViewHolder(binding.root){
