...
class EpicTourGuidesAdapter: RecyclerView.Adapter<EpicTourGuidesAdapter.EpicTourGuidesViewHolder>() {

    inner class EpicTourGuidesViewHolder(private val binding: BaseepicdealsRvItemBinding): RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): EpicTourGuidesViewHolder {
        return EpicTourGuidesViewHolder(
    ...
    override fun onBindViewHolder(holder: EpicTourGuidesViewHolder, position: Int) {
