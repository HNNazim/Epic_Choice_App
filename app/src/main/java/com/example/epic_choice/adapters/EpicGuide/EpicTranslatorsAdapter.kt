package com.example.epic_choice.adapters.EpicGuide
...
class EpicTranslatorsAdapter: RecyclerView.Adapter<EpicTranslatorsAdapter.EpicTranslatorsViewHolder>() {

    var onClick: ((Product) -> Unit)? = null

    inner class EpicTranslatorsViewHolder(private val binding: EpicbaseRvItemBinding): RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): EpicTranslatorsViewHolder {
        return EpicTranslatorsViewHolder(
    ...
    override fun onBindViewHolder(holder: EpicTranslatorsViewHolder, position: Int) {
