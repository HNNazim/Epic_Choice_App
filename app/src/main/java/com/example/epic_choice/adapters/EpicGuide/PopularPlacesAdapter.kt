...
class PopularPlacesAdapter: RecyclerView.Adapter<PopularPlacesAdapter.PopularPlacesViewHolder>() {

    inner class PopularPlacesViewHolder(private val binding: EpicbaseRvItemBinding): RecyclerView.ViewHolder(binding.root){
