...
class EpicTourPacksAdapter: RecyclerView.Adapter<EpicTourPacksAdapter.EpicTourPackViewHolder>() {

    inner class EpicTourPackViewHolder(private val binding: BaseepicdealsRvItemBinding): RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): com.example.epic_choice.adapters.EpicRide.EpicTourPacksAdapter.EpicTourPackViewHolder {
        return EpicTourPackViewHolder(
    ...
    override fun onBindViewHolder(holder: com.example.epic_choice.adapters.EpicRide.EpicTourPacksAdapter.EpicTourPackViewHolder, position: Int) {
