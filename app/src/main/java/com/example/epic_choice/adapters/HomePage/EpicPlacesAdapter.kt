...
import com.example.epic_choice.databinding.EpicplacesRvItemBinding

class EpicPlacesAdapter: RecyclerView.Adapter<EpicPlacesAdapter.EpicPlacesViewHolder>() {

    inner class EpicPlacesViewHolder(private val binding:EpicplacesRvItemBinding ):RecyclerView.ViewHolder(binding.root){
        fun bind(product: Product){
           binding.apply {
               ...
               favIMG.setImageResource(favoriteIconRes)
               ...
               favIMG.setOnClickListener {
                   ...
                   favIMG.setImageResource(updatedIconRes)
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): EpicPlacesViewHolder {
        return EpicPlacesViewHolder(
            EpicplacesRvItemBinding.inflate(
                LayoutInflater.from(parent.context),parent,false
            )
        )
    }

    override fun onBindViewHolder(holder: EpicPlacesViewHolder, position: Int) {
